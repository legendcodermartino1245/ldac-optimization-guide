...
- [LDAC Adaptive Bitrate Behavior](#adaptive-bitrate-ldac)
...
- [False Resets & Misleading Behaviors](#-false-resets--misleading-behaviors-do-not-work)
- [Fast Pair Override Behavior](#fast-pair)
- [Bluetooth Connection Method Comparison](#-bluetooth-connection-methods--ranked-by-override-speed-and-bcc-compatibility)
- [Complete LDAC Codec Reset Matrix (v2025)](#-complete-ldac-codec-reset-matrix-v2025)
- [Manual Override Hijack (Legacy)](#-manual-override-hijack-legacy-method--for-non-automated-setups)
- [Fast Pair Auto-Sync Lockout (GUI Only)](#-full-google-play-services-lockdown-gui-only-method)
- [Multipoint LDAC Overview](#-multipoint-ldac-overview)
- [Multipoint Stability Factors](#-ldac-multipoint-stability-factors)
- [Multipoint AV/AVRCP Matrix](#-multipoint-avavrcp-combination-matrix-ldac-on-both-devices)
- [Volume Level Mapping (Android ↔ Windows)](#windows-volume-level-with-av-on-on-both-devices)
- [Alternative A2DP Driver for Windows](#-alternative-a2dp-driver--android--windows-ldac-multipoint-notes)
- [Windows Audio Clean Output Setup](#-windows-audio-clean-output-settings-for-ldac-multipoint)
- [AVRCP Behavior and Registry Limitations](#-avrcrp-behavior-and-multipoint-issues)
- [Multipoint + LDAC Dual Control Behavior](#-multipoint--ldac-dual-control-behavior)
- [Controlling AVRCP Version with Hardware](#-controlling-avrcp-version-you-cant--unless-you-change-hardware)
- [What Needs to Match for Multipoint LDAC](#-ldac-multipoint-what-actually-needs-to-match)
- [LDAC Control Roles](#-ldac-control-roles)
- [Multipoint Codec Confirmation](#-ldac-multipoint-confirmation)
- [Multipoint Final Test Results](#-final-test-results)
- [Final Takeaways](#-final-takeaways)
- [Sound Connect Multipoint Tips](#-windows--android-multipoint-tips-ldac--bluetooth)
- [Absolute Volume Summary](#absolute-volume)
- [Sony Music Center Volume Mapping](#music-center)
- [Music Center Codec Reassertion Behavior](#-background-behavior--music-center-codec-reassertion)
- [Headphone Firmware Storage Behavior](#-headphone-firmware-storage-behavior-sony-wh-1000xm5)
# LDAC Done Right
