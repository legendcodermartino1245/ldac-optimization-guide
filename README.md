## 📁 Full Table of Contents for LDAC Done Right

### 🔧 Setup & Introduction
- [My Setup and the Hardware I Used](#my-setup-and-the-hardware-i-used)

### ⚙️ Codec Mechanics & Matrices
...
- [The Real LDAC Bug: Quality Settings Don’t Apply](#the-real-ldac-bug-quality-settings-dont-apply)

### 📡 LDAC Override & Stack Behavior
- [Samsung LDAC Override Stack](#-samsung-ldac-override-stack)
- [Developer Options Are Safe – If You Clean Up](#-developer-options-are-safe--if-you-clean-up)
- [Codec Negotiation Limits and Override Timing](#-codec-negotiation-limits-and-override-timing)

### 🛠️ Tools & Bypass Strategies
...
### 🪜 Reset Strategies & Detection
- [Valid LDAC Codec Reset Strategies (Ranked)](#-valid-ldac-codec-reset-strategies-ranked)
- [False Resets & Misleading Behaviors (Do Not Work)](#-false-resets--misleading-behaviors-do-not-work)

### ⚡ Fast Pair & Manual Pairing Control
- [Fast Pair](#fast-pair)
...
### 🔄 LDAC Multipoint & Dual-LDAC Setup
...
- [AVRCP Behavior and Multipoint Issues](#-avrcrp-behavior-and-multipoint-issues)
...
- [LDAC Multipoint — What Actually Needs to Match](#-ldac-multipoint--what-actually-needs-to-match)
...
### 🧪 Advanced Firmware & Codec Behavior
- [LDAC Profile Persistence Table](#ldac-profile-persistence-table)
- [Override Persistence Detection](#override-persistence-detection)
- [AV OFF Breaks SBC Reset](#av-off-breaks-sbc-reset)
- [AV OFF Breaks Intermediate Profiles](#av-off-breaks-intermediate-profiles)
- [AV OFF Enables Sony Override Reassertion](#av-off-enables-sony-override-reassertion)
- [Music Center Is Not Passive](#music-center-is-not-passive)
- [GUI Is Not Truthful](#gui-is-not-truthful)
- [Manual vs Stored Profile Behavior](#manual-vs-stored-profile-behavior)
- [SBC Selection Replaces Developer Options Cleanup](#sbc-selection-replaces-developer-options-cleanup)
- [New Manual Reset Strategy (SBC + Storage)](#new-manual-reset-strategy-sbc--storage)
- [Fast Pair Codec Training Loop](#fast-pair-codec-training-loop)
- [Profile Isolation Logic](#profile-isolation-logic)
- [GUI Desync Detection and Correction](#gui-desync-detection-and-correction)
- [Profile Chaining Order](#profile-chaining-order)
- [Auto Reset Failure Modes](#auto-reset-failure-modes)
- [BCC Two-Step Behavior (GUI Lies)](#bcc-two-step-behavior-gui-lies)
- [Fast Pair Reassertion Timing](#fast-pair-reassertion-timing)
- [LDAC Codec Generation Factors](#ldac-codec-generation-factors)
- [Android Audio Mixer Rejection Behavior](#android-audio-mixer-rejection-behavior)
- [Re-pairing vs Reset vs Override Removal](#re-pairing-vs-reset-vs-override-removal)
- [System Cleanup Effectiveness](#system-cleanup-effectiveness)
- [App-Specific Codec Behavior](#app-specific-codec-behavior)
- [Advanced App Delay Matrix](#advanced-app-delay-matrix)
- [DSEE + DSSE Impact](#dsee--dsse-impact)
- [EQ Mode Impact](#eq-mode-impact)
- [LDAC Profile Match Conditions](#ldac-profile-match-conditions)

### 🔍 Final Observations, App Behavior & Metadata
- [Codec Inheritance](#codec-inheritance)
- [Is LDAC App-Dependent?](#is-ldac-app-dependent)
- [Stability Tier: LDAC Adaptive Sample Rate](#stability-tier-ldac-adaptive-sample-rate)
- [Verifying Sample Rate Stability](#verifying-sample-rate-stability)
- [AV OFF vs AV ON — Summary](#av-off-vs-av-on--summary)
- [App Codec Verification – LDAC](#app-codec-verification--ldac)
- [App-Specific Codec Matrix](#app-specific-codec-matrix)
- [Codec Switching Delays – App Specific](#codec-switching-delays--app-specific)
- [Metadata Delay ≠ Codec Delay](#metadata-delay--codec-delay)
- [App-Level Metadata Visibility](#app-level-metadata-visibility)
- [Bitrate Display Bugs](#bitrate-display-bugs)
- [Sample Rate Override Bugs](#sample-rate-override-bugs)
- [Track Info Delay](#track-info-delay)
- [Real-Time Codec Switching Test](#real-time-codec-switching-test)

### 🧪 Testing, Verification, and Miscellaneous Findings
- [LDAC Bitrate Logging](#ldac-bitrate-logging)
- [BCC Bug: Profile Not Applied](#bcc-bug-profile-not-applied)
- [BCC Sample Rate Bug](#bcc-sample-rate-bug)
- [UAPP App Behavior](#uapp-app-behavior)
- [Neutron App Behavior](#neutron-app-behavior)
- [Poweramp App Behavior](#poweramp-app-behavior)
- [Qobuz App Behavior](#qobuz-app-behavior)
- [Roon App Behavior](#roon-app-behavior)
- [Volume Behavior: AV ON vs OFF](#volume-behavior-av-on-vs-off)
- [Volume Step Mapping – Android vs Headphones](#volume-step-mapping--android-vs-headphones)
- [Perceived Clarity – AV ON vs OFF](#perceived-clarity--av-on-vs-off)
- [LDAC Done Right – Conclusion](#ldac-done-right--conclusion)
...
| AVRCP version                | Use **1.6 on Android**, **1.5 on Windows**                          | 1.5 on Windows avoids playback interruptions; 1.6 on Android keeps fast metadata and control |
